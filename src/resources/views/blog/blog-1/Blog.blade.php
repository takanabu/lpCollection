                                ...
                                <div class="sidebar-ttl">
                                    <img class=face src="{{ asset('img/blog/mlv0.png') }}" alt="">
                                        ...
                                        <p class=introduction>
                                            ...
                                            <br>そしてまず基礎を学ぶ為に、半年間で６６万ゴールドするオンライン魔法(プログラミング)教室を受講する。<br>
                                            教室を卒業後、魔法使い(プログラマー)としての仕事を求め、アプリ魔法開発会社に数十社、応募する、が全て断られる (多分、年齢的な壁で)・・・。<br>
                                            仕方なく、フリーランス魔法使いとしてゴールドが稼げるようになる方法を模索。<br>学校で習った知識を無駄にしないように自分のサイトを作製、運営し、そのチャレンジ過程をこのサイトで公開していきます。
                                        </p>
                                </div>
                            </div>
                        </aside>
