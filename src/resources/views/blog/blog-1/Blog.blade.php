                                ...
                                <div class="sidebar-ttl">
                                    <img class=face src="{{ asset('img/blog/mlv0.png') }}" alt="">
                                        ...
                                        <p class=introduction>
                                            「プログラミングって現代の魔法！」と４５歳で気づき、この魔法は人類をより便利にし、そして救う！」と、勝手に考え「残り少ない人生、魔法使い (何らかのプログラマー)として世の為に生きる。」と決意する。
                                            <br>そしてまず基礎を学ぶ為に、半年間で６６万ゴールドもするオンライン魔法(プログラミング)教室を受講する。<br>
                                            教室を卒業後、魔法使い(プログラマー)としての仕事を求め、アプリ魔法開発会社に数十社、応募する、が全て断られる (多分、年齢的な壁で)・・・。<br>
                                            仕方なく、フリーランス魔法使いとしてゴールドが稼げるようになる事を目指してその方法を模索中。<br>更に魔法(プログラミング)学校で習った知識を無駄にしないように自分のサイトを作成(実際つくったら大変すぎてやめたくなる)、日々修正更新、運営し、レベル上げ及びその他もろもろの冒険チャレンジ過程をこのサイトで公開していきます。
                                        </p>
                                </div>
                            </div>
                        </aside>
